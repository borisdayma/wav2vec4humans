...
class DataTrainingArguments:
    ...
    chars_to_ignore_fr = ["«","»","ł",,"(",")","ø","–","=","ş","ı","“","\u0301","ř","ý","‘","”","ț","ś","ż","ò","ę","đ","ð","ą","·","ī","_","$","/","°","ė","ğ","ě","ÿ","`","ē","ì","\u0307","ʻ","β","}","ő","ź","{","|","ņ","õ","ʿ","α","σ","ả","þ","ṣ","ŏ","ň","€","π","„","ľ","*","ʾ","ʼ","%","ĩ","£","δ","κ","ţ","ạ","~","ṇ","ť","γ","ļ","ω","ṯ","ễ","ů","×","ệ","ầ","ư","ơ","^","ṭ","ǃ","†","±","→","μ","∆","ل","ا","г","ċ","の","ị","ồ","ề","ρ","ː","ν","ǹ","ộ","≥","е","а","′","ũ","τ","ʉ","ο","ψ","ي","ن","\u0331","星","ǎ","ጠ","ぬ","ắ","א","к","ķ","ҫ","ậ","ờ","ḍ","ṅ","−","ǫ","ɨ","ủ","ǀ","‹","›","и","з","м","н","め","や","ε","®","ǔ","∞","ẵ","1","⁄","2","§","―","ĺ","☉","υ","п","ι","ό","西","甌","\u0310","い","م","ة","і","ب","ر","و","د","ј","ħ","∅","ď","∼","θ","\u0320","գ","ζ","─","ử","北","京","美","术","馆","た","つ","ợ","文","ə","ʽ","э","へ","ま","ġ","ደ","η","ỳ","杜","乃","扬","∨","\u0332","р","ų","∈","զ","青","貴","う","ゔ","ꝑ","₽","ወ","‐","я","먹","삼","생","고","기","집","ʔ","ひ","ổ","ቀ"]
...
def main():
    ...
    chars_to_ignore_regex = f'[{"".join(data_args.chars_to_ignore_fr)}]'

    def remove_special_characters(batch):
        batch["text"] = re.sub(chars_to_ignore_regex, "", unicodedata.normalize('NFKC', batch["sentence"]).casefold()) + " "
        batch["text"] = re.sub("'", "’", batch["text"])
        batch["text"] = re.sub("—", "-", batch["text"])
        batch["text"] = re.sub("áäāãăå", "a", batch["text"])
        batch["text"] = re.sub("í", "i", batch["text"])
        batch["text"] = re.sub("öóō", "o", batch["text"])
        batch["text"] = re.sub("šș", "s", batch["text"])
        batch["text"] = re.sub("ćč", "c", batch["text"])
        batch["text"] = re.sub("&", "et", batch["text"])
        batch["text"] = re.sub("ñń", "n", batch["text"])
        batch["text"] = re.sub("úu", "u", batch["text"])
    ...
    def test_speech_file_to_array_fn(batch):
        batch["sentence"] = re.sub(chars_to_ignore_regex, "", unicodedata.normalize('NFKC', batch["sentence"]).casefold())
        batch["sentence"] = re.sub("'", "’", batch["sentence"])
        batch["sentence"] = re.sub("—", "-", batch["sentence"])
        batch["sentence"] = re.sub("áäāãăå", "a", batch["sentence"])
        batch["sentence"] = re.sub("í", "i", batch["sentence"])
        batch["sentence"] = re.sub("öóō", "o", batch["sentence"])
        batch["sentence"] = re.sub("šș", "s", batch["sentence"])
        batch["sentence"] = re.sub("ćč", "c", batch["sentence"])
        batch["sentence"] = re.sub("&", "et", batch["sentence"])
        batch["sentence"] = re.sub("ñń", "n", batch["sentence"])
        batch["sentence"] = re.sub("úu", "u", batch["sentence"])
